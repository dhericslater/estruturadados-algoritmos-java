...
import com.slater.estruturadados.vetor.teste.Contato;
...
public class Ex06 {
	...
	private static void imprimeTamanhoVetor(Lista<Contato> lista) {
		...
		System.out.println("Tamanho o vetor é de: " + lista.tamanho());
	}
	...
	private static void excluirPorPosicao(Scanner scan, Lista<Contato> lista) {
		...
		try {
			...
			System.out.println("Posição invália!");
		}

	}

	private static void excluiContato(Scanner scan, Lista<Contato> lista) {
